...
object RootHelper {
    ...
    fun installBootScript(packageName: String, serviceName: String): Boolean {
        return try {
            ...
            os.writeBytes("echo '  /system/bin/am startservice -n $packageName/$serviceName' >> /data/adb/service.d/ava_boot.sh\n")
            os.writeBytes("echo '  sleep 5' >> /data/adb/service.d/ava_boot.sh\n")
            os.writeBytes("echo '  pgrep -f $packageName > /dev/null && break' >> /data/adb/service.d/ava_boot.sh\n")
